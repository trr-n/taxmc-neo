...
namespace trrne.Box
{
    ...
    {
        public static Vector2 Size(this Collider2D collider)
        => collider.bounds.size;
        public static Vector2 Size(this SpriteRenderer sr)
        => sr.bounds.size;
        ...
        public static Vector2 SpriteSize(this SpriteRenderer sr)
        => sr.bounds.size;
        ...
        public static void TextSettings(
            this Text text,
           TextAnchor anchor,
           VerticalWrapMode vw,
        ...
        => new(0, 0, 0, 0);
        public static Color Gaming
        => Color.HSVToRGB(Time.unscaledTime % 1, 1, 1);
