...
namespace trrne.Body
{
    public class Newbie : Enemy
    {
        ...
        {
            horizon.ray = new(transform.position - (Coord.x * layer.distance / 2), transform.right);
            ...
            Vector2 rayconf = transform.position + (layer.distance * Coord.y / 2);
        ...
        {
            transform.Translate(Time.deltaTime * speed.real * Coord.x);
        }
    }
}