...
namespace trrne.Bag
{
    ...
    public static class Gobject
    {
        ...
        public static bool BoxCast2D(out RaycastHit2D hit, Vector2 center, Vector2 size) => hit = Physics2D.BoxCast(center, size, 0, Vector2.up);
        public static bool BoxCast2D(out RaycastHit2D hit, Vector2 center, Vector2 size, int layer) => hit = Physics2D.BoxCast(center, size, 0, Vector2.up, 1, layer);
